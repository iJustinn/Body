...
//
//  Mirrored in `BodyTests/WatchComputeMergeTests` — `WatchComputeMerge` compiles
//  into both apps, and the watch test scheme is unproven from CLI (precedent:
//  `BodyTests/WatchMetricHasValueTests`).
//
