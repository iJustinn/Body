...
final class ProjectConfigurationTests: XCTestCase {
    ...
    func testVersionDocumentationAndSettingsFallbackMatchCurrentRelease() throws {
        ...
        XCTAssertTrue(readme.contains("Current app version: **0.9.10 (build 11)**"))
        ...
        XCTAssertTrue(versionHistory.contains("Redesigned the share card for gradient-preset backgrounds."))
    ...
    func testTestPlanCoversCurrentBranchAndBodyProSurface() throws {
        ...
        XCTAssertTrue(testPlan.contains("app version 0.9.10 build 11)"))
