...
final class LocalizationRuntimeKeyTests: XCTestCase {
    ...
    func testSyncBadgeStageKeysAreTranslated() throws {
        ...
        let keys = [
            ...
            "Updating Heart Rate...",
            "Updating Resting Heart Rate...",
            "Updating Weight...",
            "Updating Body Fat...",
            "Updating Heart Rate Variability...",
            "Updating Respiratory Rate...",
            "Updating Blood Oxygen...",
            "Updating Body Mass Index...",
            "Updating Active Energy...",
            "Updating Resting Energy...",
            "Updating Exercise Minutes...",
            "Updating Training Load...",
            "Updating Wrist Temperature...",
            "Updating Time in Daylight...",
            "Updating Steps...",
            "Updating Vitals...",
            "Updating Cardio Fitness...",
