...
- **The share page is now an Instagram-Story-style composer.** The option strip below the preview is gone — a vertical icon rail (Font, Ratio, Arrange, Route Color, Background, 3D) sits over the leading edge of the full-bleed preview, and tapping an icon expands a tray of that option's tiles beside it, one tray open at a time; tapping the preview closes the open tray.
