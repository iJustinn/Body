...
- **Redesigned paywall.** The Body Pro page opens on a headline with four highlights, then plan cards with Yearly preselected: a free trial tag (or Best Value once the trial is used), a Save badge worked out from the two storefront prices and rounded down (neither shows where Yearly saves nothing), Monthly, and Lifetime with a Just Me / Family switch. An eligible trial adds a timeline with today and the real billing date. A sticky gold button (Start Free Trial, Subscribe, or Unlock Lifetime) shows the price and renewal terms beside it, and the footer links the Terms of Use and Privacy Policy with the auto-renewal terms. Paywall sheets opened from locked controls now have a close button. The trial is only offered when RevenueCat confirms the customer is still eligible, and Restore reports an expired subscription as nothing to restore while an owned lifetime purchase still gets the recovery card.
