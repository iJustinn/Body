...
Older lessons archived out of `LessonsLearned.md` to keep the active file short. Entries are preserved verbatim in the order they were originally written. Search here when planning a large or risky change to confirm a past gotcha isn't about to bite again.

Active lessons live in `LessonsLearned.md` at the repo root.
